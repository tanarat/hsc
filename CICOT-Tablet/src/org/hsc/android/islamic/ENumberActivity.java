...
public class ENumberActivity extends Activity {
	MyAndroidApp myapp;
	...
	public void search(View view) {
		...
		// ENumber eNumberFound = new ENumber("100", "abc", "description",
		// ENumber.STATUS_HALAL_IF_NO_ALCOHOL, null);

		ENumber eNumberFound = eNumberDAO.get(eNumberSearch);
		...
		if (eNumberFound != null) {
			...
			txtDesc.setText("");
			txtStatus.setText("");
			imgStatusView.setImageResource(R.drawable.unknown);
		}
	}
