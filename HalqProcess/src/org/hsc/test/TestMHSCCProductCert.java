...
public class TestMHSCCProductCert {
	Properties ctx;
	@Before
	...
	public void testAddCertificates() {
		...
		int requestProductID = 1000014;
		MHSCRequestProduct reqProduct = new MHSCRequestProduct(ctx, requestProductID, null);
		reqProduct.addCertificates(centerCerts);
	}
