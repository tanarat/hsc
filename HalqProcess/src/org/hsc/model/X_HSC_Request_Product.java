...
/** Generated Model for HSC_Request_Product
 *  @author Adempiere (generated) 
 *  @version Release 3.6.0LTS - $Id$ */
public class X_HSC_Request_Product extends PO implements I_HSC_Request_Product, I_Persistent 
{
    ...
    public X_HSC_Request_Product (Properties ctx, int HSC_Request_Product_ID, String trxName)
    {
      super (ctx, HSC_Request_Product_ID, trxName);
      /** if (HSC_Request_Product_ID == 0)
        {
			setC_BPartner_ID (0);
    ...
    /** Load Constructor */
    public X_HSC_Request_Product (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_HSC_Request_Product[")
	...
	public void setHSC_Request_Product_ID (int HSC_Request_Product_ID)
	{
		if (HSC_Request_Product_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_HSC_Request_Product_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_HSC_Request_Product_ID, Integer.valueOf(HSC_Request_Product_ID));
	}
