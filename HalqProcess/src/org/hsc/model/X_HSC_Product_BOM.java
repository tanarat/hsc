...
/** Generated Model for HSC_Product_BOM
 *  @author Adempiere (generated) 
 *  @version Release 3.6.0LTS - $Id$ */
public class X_HSC_Product_BOM extends PO implements I_HSC_Product_BOM, I_Persistent 
{
    ...
    public X_HSC_Product_BOM (Properties ctx, int HSC_Product_BOM_ID, String trxName)
    {
      super (ctx, HSC_Product_BOM_ID, trxName);
      /** if (HSC_Product_BOM_ID == 0)
        {
    ...
    /** Load Constructor */
    public X_HSC_Product_BOM (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_HSC_Product_BOM[")
	...
	public void setHSC_Product_BOM_ID (int HSC_Product_BOM_ID)
	{
		if (HSC_Product_BOM_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_HSC_Product_BOM_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_HSC_Product_BOM_ID, Integer.valueOf(HSC_Product_BOM_ID));
	}
