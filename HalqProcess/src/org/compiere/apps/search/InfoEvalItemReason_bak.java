...
import org.hsc.model.X_HSC_Eval_Item_Reason;
 ...
 */
public class InfoEvalItemReason_bak extends Info
{
	/**
	 * 
	 */
...
//	private static final long serialVersionUID = 5550733934685665946L;
	 ...
	 */
	public InfoEvalItemReason_bak(Frame frame, boolean modal, int WindowNo,
	...
	public InfoEvalItemReason_bak(Frame frame, boolean modal, int WindowNo, String value,
			String tableName, String keyColumn,
			boolean multiSelection, String whereClause){
		// TODO Auto-generated constructor stub
		super (frame, modal, WindowNo, tableName, keyColumn, multiSelection, whereClause);
		System.out.println(value);
		setTitle(Msg.getMsg(Env.getCtx(), "InfoItemReason"));
//		statInit(1);
		initInfo(value, whereClause);
		//
		int no = p_table.getRowCount();
	...
	private CLabel lblEvalItem = new CLabel();
	private CTextField txtEvalItem = new CTextField(10);
...
//	};
	private static Info_Column[] columns = {new Info_Column("", "HSC_Eval_Item_Reason.Name", String.class)};
	//
	...
	private void statInit(int x)
	{
		lblEvalItem.setText("Evaluation Item");
		txtEvalItem.addActionListener(this);
...
//		checkCustomer.addActionListener(this);
		...
		//
		parameterPanel.add(lblEvalItem,new ALayoutConstraint(0,0));
		parameterPanel.add(txtEvalItem, null);
...
//		
		...
		for (Iterator iterator = set.iterator(); iterator.hasNext();) {
			...
			System.out.println("-->" + prop.getProperty(object.toString()));
		}
		System.out.println(whereClause);
		where.append("HSC_Eval_Item_ID = "+ prop.getProperty("2|1|HSC_Eval_Item_ID"));
		if (whereClause != null && whereClause.length() == 0)
