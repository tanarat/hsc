...
public class MProduct extends X_M_Product
{
	 ...
	 * 
	 */
	private MHSCCertification[] certificates;
	public MHSCCertification[] getCertificates(boolean reload){
	...
	private void reloadCertificates(){
		String table = MHSCCertification.Table_Name;
		String whereClause = "IsActive = 'Y' and hsc_certification_id in (select hsc_certification_id from hsc_product_cert where m_product_id = ?)";
		List<MHSCCertification> certs = new Query(getCtx(), table, whereClause, get_TrxName()).setParameters(get_ID()).list();
		certificates = certs.toArray(new MHSCCertification[certs.size()]);
	}
}	//	MProduct
